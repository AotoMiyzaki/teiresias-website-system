...
const steps = [
  ...
  },
  {
    ...
    title: '開発範囲の整理',
    description:
      'すべてを一度に作るのではなく、優先度と必要性から最初の開発範囲を決めます。',
  },
  {
    number: '04',
    title: '画面・仕様設計',
    description:
      '利用者、権限、入力項目、確認方法、画面遷移、帳票などを設計します。',
  },
  {
    number: '05',
    title: '開発・確認',
    description:
      '機能を段階的に開発し、画面や動作を確認してもらいながら調整します。',
  },
  {
    number: '06',
    title: '試験導入',
    description:
      '必要に応じて、一部の店舗や部署から利用を始め、実際の業務で問題がないかを確認します。',
  },
  {
    number: '07',
    title: '本番導入・改善',
    description:
      '利用範囲を広げ、実際の利用状況や業務変更に合わせて機能を改善します。',
  },
]
  ...
  return (
    <>
      ...
      <main id="main-content" className="detail-page process-page" tabIndex={-1}>
        ...
        <PageCta
          title="現在の業務から、最初の開発範囲を整理します。"
          description="システムの仕様が決まっていない段階でも、現在の運用からご相談いただけます。"
        />
      </main>
    </>
  )
